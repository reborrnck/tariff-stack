...
<body>
  <header class="site"><div class="site-inner"><div class="site-l"><a href="/">TariffStack</a><span class="sub" data-i18n="h1">{h1_en}</span></div><a href="/about" class="site-r" data-i18n="about_link">{{d.about_link}}</a></div></header>
  <main class="wrap">
